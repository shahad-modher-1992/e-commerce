                ...
                <div class="panel-body">
                    ...
                    @endif
                     ...
                     <div class="form-group">
                         ...
                         <div class="col-md-4">
                           <input type="text" class="form-control input-md" name="name" placeholder="Catigory Name">
                         </div>
                     </div>
                     {{-- <div class="form-group">
                         <label for="" class="col-md-4 control-label">Catigory Slug</label>
                         <div class="col-md-4">
                           <input type="text" class="form-control input-md" name="slug" placeholder="Catigory Slug">
                         </div>
                     </div> --}}
                     <div class="form-group">
