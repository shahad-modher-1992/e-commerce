        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    @endif --}}
                      <form action="{{ route("home.store") }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                     @csrf
                     ...
                     <div class="form-group">
                         ...
                         <div class="col-md-4">
                           <input type="text" class="form-control input-md" name="link" placeholder="Link">
                         </div>
                     </div>
                     <div class="form-group">
                         <label for="" class="col-md-4 control-label">Status </label>
                         <div class="col-md-4">
                           <input type="text" class="form-control input-md" name="status" placeholder="Status">
                         </div>
                     </div>
