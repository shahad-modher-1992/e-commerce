            ...
            <div class="wrap-address-billing">
                ...
                <form action="{{ route('order.store') }}" method="POST" name="frm-billing">
                    ...
                    <p class="row-in-form">
                        ...
                        <input id="fname" type="text" name="name" value="{{ Auth::user()->name }}" placeholder="Your name">
                    </p>
                    ...
                    <p class="row-in-form">
                        ...
                        <input id="add" type="text" name="address" value="" placeholder="Your Adress">
                    </p>
                    <p class="row-in-form">
                        <label for="add">Payment method:</label>
                        <input id="add" type="text" name="payment_method" value="" placeholder="Your Adress">
                    </p>
