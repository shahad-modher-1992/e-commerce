...
let list = $('.product-list .list').html();
// $(document).on('keyup', '#orderby', function(){
...
//                 $('.product-list .list').html(data.row_result); 
//             }          
//         })
//     } else {
//         $('.product-list .list').html(list)
//     }
// });
// $(document).on('keyup', '#sorting', function(){
